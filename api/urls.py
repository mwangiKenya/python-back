...
urlpatterns =[
    ...
    path('download-user-payment-history/<int:user_id>/', download_user_payment_history, name='download_user_payment_history'),
    # Reading History URLs
    path('reading-history/', get_reading_history_list, name='get_reading_history_list'),
    ...
    path('extract-billings-excel/', extract_billings_excel),
    path('commit-billings-excel/', commit_billings_excel),
    path('rollback-billings-excel/', rollback_billings_excel),
